...
wget --no-check-certificate -qO '/tmp/linux-image-4.14.153_4.14.153-1_amd64.deb' 'https://github.com/DroidBeta/BBR/releases/latest/download/linux-image-4.14.153_4.14.153-1_amd64.deb'
